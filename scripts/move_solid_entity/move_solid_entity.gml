/// @description move_solid_entity(push_objects)
/// @param push_objects
/*
...
var push_objects = argument0; // Object to push
...
var instances = instances_place_multiple(x+hspd+sign(hspd), y, push_objects);
var last_hsp0 = hsp[0];
var last_hsp1 = hsp[1];
...
var top_instances = instances_place_multiple(x, y-(abs(vspd)+1), push_objects);
var last_vsp0 = vsp[0];
var last_vsp1 = vsp[1];
...
var bottom_instances = instances_place_multiple(x, y+(abs(vspd)+1)+vspd, push_objects);
