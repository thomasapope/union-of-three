/// @description add_movement_horizontal_vertical_maxspeed(hacceleration, vacceleration, maxhspeed, maxvspeed, axis)
/// @param hacceleration
/// @param  vacceleration
/// @param  maxhspeed
/// @param  maxvspeed
...
hsp[0] = approach_movespeed(hsp[0], maxhspd, abs(hacc), xaxis);
